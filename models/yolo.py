...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, Conv, RobustConv, RobustConv2, DWConv, GhostConv, RepConv, RepConv_OREPA, DownC, 
                 ...
                 SwinTransformer2Block, ST2CSPA, ST2CSPB, ST2CSPC, PConv, CBAM, ECA, CA, ACmix, Conv_BN_HSwish, MobileNetV3_InvertedResidual, BasicStage, PatchEmbed_FasterNet, PatchMerging_FasterNet]:
            c1, c2 = ch[f], args[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='../cfg/training/yolov7-tiny-pconv.yaml', help='model.yaml')
